    ...
    <div className="onboard">
      <div className="onboard-card" style={{maxWidth:440}}>
        <div style={{display:'flex', alignItems:'center', gap:12, marginBottom:20}}>
          <div className="brand-mark" style={{width:44, height:44, fontSize:20}}>M<span style={{opacity:.7}}>s</span></div>
          <div className="brand-name" style={{fontSize:24}}>My<span className="dot">·</span>Salma</div>
        </div>
        ...
        <input className="input" type="email" value={email} onChange={e=>setEmail(e.target.value)} placeholder="you@salma-rehab.org"
        ...
        <div style={{textAlign:'center', marginTop:16, fontSize:13.5, color:'var(--ink-soft)'}}>
          {mode === 'signin' ? "New to MySalma? " : 'Already have an account? '}
