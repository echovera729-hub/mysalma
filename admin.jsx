  ...
  return (
    <div className="onboard">
      <div className="onboard-card" style={{maxWidth:460, textAlign:'center'}}>
        <div className="brand-mark" style={{width:56, height:56, fontSize:26, margin:'0 auto'}}>M<span style={{opacity:.7}}>s</span></div>
        ...
        <p className="onboard-sub" style={{maxWidth:380, margin:'8px auto 0'}}>
          Your account is waiting for an administrator to approve it. This keeps MySalma to verified hospital staff only.
        </p>
  ...
  return (
    <div className="onboard">
      <div className="onboard-card" style={{maxWidth:460, textAlign:'center'}}>
        ...
        <p className="onboard-sub" style={{maxWidth:380, margin:'8px auto 0'}}>
          This account wasn't approved for MySalma. If you think that's a mistake, reach out to your administrator and they can re-approve you.
        </p>
        <button className="btn" style={{marginTop:20}} onClick={() => Store.signOut()}>Sign out</button>
      </div>
    </div>
    ...
    <>
      ...
      {tab === 'pending' && (
        <div className="banner" style={{marginBottom:16}}>
          ✅ <span>New sign-ups land here. <strong>Approve</strong> to let them into MySalma, or <strong>reject</strong> to keep them out. Approval is instant on their end.</span>
        </div>
      )}
